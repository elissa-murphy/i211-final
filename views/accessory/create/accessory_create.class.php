...
class AccessoryCreate extends AccessoryIndex
{
    ...
    <form class="new-media" action='<?= BASE_URL?>/accessory/index' method="post" style="border: 1px solid #bbb; margin-top: 10px; padding: 10px;">
        <p><strong>Name</strong><br>
            <input name="first_name" type="text" size="100" id="first_name" required autofocus></p>
        <p><strong>Maker</strong><br>
            <input name="last_name" type="text" size="100" id="last_name" required autofocus></p>
